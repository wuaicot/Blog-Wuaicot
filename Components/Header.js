      ...
      {!topic && (
        <div className="pt-24 px-12 mx-auto max-w-7xl">
          <div className="w-full mx-auto text-left md:w-11/12 xl:w-9/12 md:text-center">
            ...
            Welcome to Blog-Wuaicot
            </p>

            <h1 className="mb-8 text-4xl font-bold leading-none tracking-normal text-gray-900 md:text-6xl md:tracking-tight dark:text-gray-50 animate-pulse">
              <span>Explore</span>{" "}
              ...
              <span className="animate-pulse">Build 🚀</span>
            </h1>
          </div>
        </div>
      )}
